...
>
> 최종 갱신: 2026-07-16 (③ locate 1차 개선 완료 — attr-readonly 진단·수정, eval:region 85%→**88%**.
> ② decompose는 커밋 5009800으로 일단락 + README·flow SVG 최신화(미커밋))
>
> **▶ 재개 지점: ③ locate 1단계-수정① 완료(미커밋) — 0단계 베이스라인 → 0.5단계 관측 도구
...
| ③ | locate/ — 위치찾기 | 🔶 **1차 개선 완료(2026-07-16, 미커밋)** — 0단계 베이스라인→0.5단계 관측도구(테스트 페이지+SVG)→1단계 attr-readonly 진단·수정(isContentAnchor 화살표 오인). **eval:region 85%→88%(36/41), 실측 실패 0**, region-edit 238/0. 잔여=관찰 1호(되묻기 라벨 정렬)·의미론 연관성(증거 채집 중) |
| ④ | contracts/ — 설명서 삽입 | ⬜ |
...
- [x] **1단계-수정①: isContentAnchor 화살표 오인 수정 적용 (2026-07-16, 미커밋)** —
...
- [x] **1단계-수정②: disambiguation 확정 무시 수정 (2026-07-16, 미커밋)** — 실기기 채팅 라이브
