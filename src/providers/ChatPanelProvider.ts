    ...
    webviewView.webview.onDidReceiveMessage(async (msg: WebviewToHostMessage) => {
      switch (msg.type) {
        ...
        case 'clearHistory':
          ...
          break;
        case 'openGuide':
          vscode.commands.executeCommand('axiom-ai.openGuide');
          break;
        case 'openActionCards':
          vscode.commands.executeCommand('axiom-ai.openActionCards');
          break;
        ...
        case 'openDesignTokens':
          ...
          break;
        case 'openRouterMap':
          vscode.commands.executeCommand('axiom-ai.openRouterMap');
          break;
